...
오일추와 무관한 질문(수학 문제, 일반 지식, 코딩, 다른 앱 등)은 "저는 오일추 도우미라서 앱 관련 질문만 답할 수 있어요 😊 오일추 사용법이나 기능에 대해 물어봐 주세요!"라고만 답하세요.`;
  ...
  try {
    const response = await fetch(
      `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${process.env.GEMINI_API_KEY || 'AIzaSyDZBVSwRixtv18chGoOJ1WRXITHYljKUZk'}`,
      {
        method: 'POST',
